			  ...
			  <div class="col-md-10 mb-5 text-center">
				  <ul class="product-category">
					  ...
					  @foreach ($categories as $categorie)
						  <li><a href="{{URL::to('/select_par_cat/'.$categorie->category_name)}}" class="{{(request()->is('select_par_cat/'.$categorie->category_name)?'active':'')}}">{{$categorie->category_name}}</a></li>
					  @endforeach
					  ...
					  <div class="text py-3 pb-4 px-3 text-center">
						  ...
						  <div class="bottom-area d-flex px-3">
							  <div class="m-auto d-flex">
								  ...
								  <a href="{{URL::to('/ajouter_au_panier/'.$produit->id)}}" class="buy-now d-flex justify-content-center align-items-center mx-1">
